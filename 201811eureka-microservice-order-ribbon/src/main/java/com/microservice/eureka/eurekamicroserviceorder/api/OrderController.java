...
public class OrderController {
    ...
    public Object getUserInfoByUserCode3(@PathVariable String userCode){
        ...
        logger.info("microservice-eureka-user method3===>"+url);
        Object o = restTemplate.getForObject(url,Object.class);
        return o;
    }
     ...
     * @return
     */
    @RequestMapping("/method4/{userCode}")
    public Object getUserInfoByUserCode4(@PathVariable String userCode){
        String url = "http://microservice-eureka-user-2/user/getUserInfoByUserCode/"+userCode;
        logger.info("microservice-eureka-user-2 method4===>"+url);
        Object o = restTemplate.getForObject(url,Object.class);
        return o;
    }
